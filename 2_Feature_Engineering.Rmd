...
```{r}
subset(pitching_raw, (playerID=='melviti01' & yearID==2016))[['ERA']] 
```
...
computeFeature <- function(df_target, df_source, featureList, colBaseName) {
  ...
  for (feat in featureList) {
    ...
    df_target[[colName]] <- as.vector(sapply(df_target[[colBaseName]], function(x){
      subset(df_source, (playerID==x & yearID==2016))[[feat]]
    }))
  }
  df_target
}
